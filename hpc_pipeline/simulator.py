...
import os
import sys
from game import Game, sim_from_state, sim_n_games_from_state
from utils import hs_state, calc_move_scores, get_best_probs_from_count
from utils import MCTS_TREE_SIZE
...
class Simulator(mp.Process):
    ...
    def run(self):
        ...
        while True:
            ...
            cur_score, moves = self.simulate()
            i += 1
            print(self.idx, 'game: %d, moves %d, score: %.3f' % (i, moves, cur_score))
            sys.stdout.flush()
